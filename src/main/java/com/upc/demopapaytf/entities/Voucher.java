...
public class Voucher {
    ...
    public Voucher(int idVoucher, LocalDate dateVoucher, LocalDateTime hourVoucher, int destinationAccountVoucher, float amountVoucher, int numberOperationVoucher, Services serviceB) {
